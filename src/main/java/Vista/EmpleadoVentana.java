...
public class EmpleadoVentana extends javax.swing.JInternalFrame {
    ...
    private final EmpleadoControlador empleadoController;
    private TableModel modeloTablaEmpleados;
    private JDesktopPane jDesktopPane;
    
    public EmpleadoVentana(JDesktopPane jDesktopPane) {
        initComponents();
        this.empleadoController = new EmpleadoControlador();
    ...
    private void initComponents() {
        ...
        jButtonEdicion.setActionCommand("EDITAR");
        jButtonEdicion.setLabel("EDITAR");
        ...
        jButtonEdicion.getAccessibleContext().setAccessibleName("EDITAR");
