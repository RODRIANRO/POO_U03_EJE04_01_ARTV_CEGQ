...
public class DepartamentoVentana extends javax.swing.JInternalFrame {
    ...
    final DepartamentoControlador departamentoController;
    ...
    public DepartamentoVentana(JDesktopPane jDesktopPane) {
        initComponents();
        departamentoController =  new DepartamentoControlador();
    ...
    private void initComponents() {
        ...
        jButtonEditarDep.setText("EDITAR");
        jButtonEditarDep.setActionCommand("EDITAR");
        ...
        jButtonEditarDep.getAccessibleContext().setAccessibleName("EDITAR");
